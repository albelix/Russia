...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/cogco/Documents/Experiments/Averting Disaster Study 3/Code/Russia/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/cogco/Documents/Experiments/Averting Disaster Study 3/Code/Russia/venv/bin/deactivate.nu'
